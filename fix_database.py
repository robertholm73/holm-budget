...
def fix_database():
    ...
    try:
        ...
        print(f"✅ Updated {updated_accounts} account names from 'Bank 0' to 'Bank Zero'")
...
if __name__ == "__main__":
    ...
    response = input("This will clean up hardcoded accounts and fix Bank 0 -> Bank Zero. Continue? (y/N): ")
    if response.lower() == 'y':
        fix_database()
    else:
